...
public class ProdutoView {
    ...
    public static Produto form() {
        ...
        do {
            ...
            if (descricao.length() < 5) {
                JOptionPane.showInputDialog(null, "A descrição do produto precisa ter no minimo 5 digitos");
            }
    ...
    public static void show(Produto p) {
        ...
        String produtoString = String.format("PRODUTO: " + p.getNome() + System.lineSeparator()
                ...
                + "CATEGORIA: " + p.getCategoria().getNome() + System.lineSeparator()
                + "PREÇO: R$ %.2f", p.getPreco());
